  ...
  return (
    <div className="relative z-10 grid gap-8 xl:grid-cols-2 2xl:grid-cols-3">
      ...
      <div className="flex flex-col shadow-2xl">
        ...
        <div className="relative z-[1] space-y-8 bg-white py-10">
          <h5 className="text-2xl text-gray-900">
            Rs. <span className="text-6xl font-bold text-gray-900">5,000</span> p/m
          </h5>
      ...
      <div className="flex flex-col shadow-2xl">
        ...
        <div className="relative z-[1] space-y-8 bg-white py-10">
          <h5 className="text-2xl text-gray-900">
            Rs. <span className="text-6xl font-bold text-gray-800">6,000</span> p/m
          </h5>
          <ul className="space-y-3 font-medium text-gray-900">
            <li>Free Hand</li>
            <li>Gym Fitness</li>
      ...
      <div className="flex flex-col shadow-2xl xl:col-span-2 xl:w-1/2 xl:justify-self-center 2xl:col-span-1 2xl:w-auto">
        ...
        <div className="relative z-[1] space-y-8 bg-white py-10">
          <h5 className="text-2xl text-gray-900">
            Rs. <span className="text-6xl font-bold text-gray-800">10,000</span> p/m
          </h5>
          <ul className="space-y-3 font-medium text-gray-900">
            <li>Free Hand</li>
            <li>Gym Fitness</li>
